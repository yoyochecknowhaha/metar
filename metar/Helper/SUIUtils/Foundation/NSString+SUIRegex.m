...
- (BOOL)sui_isValidPassword {
    NSString *passwordRegex = @"^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!#$%^&*])[\\da-zA-Z!#$%^&*]{8,16}$";
...
//    return (ret || ret1);
   ...
   NSString *mobileNoRegex = @"^((13[0-9])|(14(0|[5-7]|9))|(15([0-3]|[5-9]))|(16(2|[5-7]))|(17[0-8])|(18[0-9])|(19([0-3]|[5-9])))\\d{8}$";//除4以外的所有个位整数，不能使用[^4,\\d]匹配，这里是否iOS Bug?
   BOOL ret = [self sui_validateByRegex:mobileNoRegex];
   return ret;
}
